...
## 文件目录规范
- 全局样式放在 styles，全局 js 放在 utils，请求放在 services，图片放在 assets
- 每个文件大于 1000 行请开始拆分
- ...
...
# 代码提交流程
新建个人分支如 dev_forever，
开发完成后，先 git pull origin dev 合并并解决冲突，push 到远程，
再 checkout dev 和 merge dev_forever，最终 push 完成

当然，各公司流程可能不一样，比如新建的是任务分支，有 commit 命名规范，或走 merge requests 才能合并，等等。
```
...
此外，在我的经验中中，我觉得业务名词也是个难点，比如教育机构关于客户/学员/试听的解释不见得符合直觉。  
