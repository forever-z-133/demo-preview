...
比如有名的 [iconFont](https://www.iconfont.cn/#!/webfont/index) 或 java 版的 [FontZip](https://github.com/forJrking/FontZip)；  
...
线下版的代表有 [Font Spider](http://font-spider.org/)。  
...
线上版的代表有 [有字库](https://www.webfont.com/)。  
